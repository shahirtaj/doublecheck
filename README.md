...
- **Vitest** for the test suite (374 tests; algorithm coverage across all 7 supported formats, including rivalry pins, plus import/share route logic and import-flow component coverage via React Testing Library)
...
Run `npm test` to execute the test suite (374 tests). See [CLAUDE.md](CLAUDE.md) for the full command reference and project structure.
