...
- **Vitest** for the test suite (279 tests; algorithm coverage across all 7 supported formats, including rivalry pins, plus import and share route logic)
...
Run `npm test` to execute the test suite (279 tests). See [CLAUDE.md](CLAUDE.md) for the full command reference and project structure.
