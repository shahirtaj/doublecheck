                  ...
                  {teams.map((_, j) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-12 sm:w-[48px] min-w-[3rem] sm:min-w-[48px] h-7 flex items-center justify-center text-[10px] border border-slate-800 box-border select-none ${cellDisabled ? "cursor-not-allowed" : "cursor-pointer"} ${cellTone}`}
                      >
                        {glyph}
                      </button>
                    );
              ...
              {manualDoubles.size > 0 && (
                <div className="flex">
                  ...
                  {doublesPerTeam().map((c, i) => (
                    <div
                      key={i}
                      className={`w-12 sm:w-[48px] min-w-[3rem] sm:min-w-[48px] h-7 flex items-center justify-center bg-slate-900 text-[8px] font-semibold border border-slate-800 box-border ${
